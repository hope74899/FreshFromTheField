...
const LatestProducts = () => {
    ...
    useEffect(() => {
        const fetchLatestProducts = async () => {
            try {
                const res = await axios.get(`${baseURL}/api/latestfamrerproducts`);
    ...
    return (
        <div className="py-4 px-4 bg-">
            <h2 className="text-2xl font-semibold mb-6 text-green-800 text-center">Latest Fresh Products</h2>
            ...
            <div className="relative">
                ...
                <div ref={scrollRef} className="w-full overflow-x-auto scrollbar-hide">
                    <div className="mx-auto flex space-x-5 w-max px-2">
