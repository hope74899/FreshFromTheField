...
const OrderHistory = () => {
    ...
    const fetchOrders = async () => {
        try {
            const response = await axios.get(`${baseURL}/api/buyer/orders-history`, {
    ...
    return (
        <div className="bg-gray-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-3xl font-bold text-green-700 mb-8 border-b-2 border-gray-200 pb-2">
                    Your Order History
                </h1>
                {orders.length === 0 ? (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-700">
                                            <strong className="font-semibold text-gray-800">Farmer:</strong>{' '}
                                            {(order.farmer &&
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-md">
                                        ...
                                        <div className="divide-y divide-gray-200">
                                            {order.items.map((item) => (
                                                <div key={item.product} className="py-2 flex justify-between text-sm">
                                        ...
                                        {order.status === 'Cancelled' && (
                                            <div className="mt-4 p-4 bg-red-50 border-l-4 border-red-700 rounded-md">
                                                ...
                                                <p className="text-sm text-gray-700">
                                                    <strong className="font-semibold text-gray-800">Cancelled By:</strong>{' '}
